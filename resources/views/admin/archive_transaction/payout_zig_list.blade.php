                                ...
                                <div class="card-body">
                                    <div>
                                        <div class="toolbar w-100">
                                            <form action="{{ route('admin.archive.payout_zig_list') }}" method="GET"
                                                ...
                                                <div>
                                                    ...
                                                    <a href="{{ route('admin.archive.payout_zig_list') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="card bg-success">
                                        <div class="card-body pb-50">
                                            <h5 class="text-white">Total Payout: <span class="fw-bolder" style="font-size:20px">{{ number_format(round($totalPayinSuccessAmount, 2)) }} PKR</span>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
